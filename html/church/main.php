<?
  ...
  echo $_GET['menu_type']."<br/>";


  if($_GET['menu_type'] == "'_income_day_doc.php'"){
...
<body>
  <div id="main_board">
    <div id="main_left_board">
      ...
      <div class="main_left_board_item" id="menu_income_doc"><a href="#" onclick="openPage('_income_day_doc.php')">수입 결의서</a></div>
